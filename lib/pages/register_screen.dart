      ...
      body: new Form(
        child: new ListView(
          ...
          children: <Widget>[
            ...
            inputField('User Name', 'Enter your user name', TextInputType.text,
                Icons.person),
            inputField('you@example.com', 'E-mail Address',
                TextInputType.emailAddress, Icons.email),
            inputField('01-03-1995', 'Birth Date', TextInputType.emailAddress,
                Icons.date_range),
            inputField('PIN', 'Enter a pin 4 digits', TextInputType.datetime,
                Icons.lock,
...
Widget inputField(String hint, String label, TextInputType type, IconData icon,
